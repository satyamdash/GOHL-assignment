...
type Transaction struct {
	...
	FromUserId    string                 `protobuf:"bytes,9,opt,name=from_user_id,json=fromUserId,proto3" json:"from_user_id,omitempty"`
	ToUserId      string                 `protobuf:"bytes,10,opt,name=to_user_id,json=toUserId,proto3" json:"to_user_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_wallet_v1_wallet_proto_rawDesc = "" +
	...
	"\ttimestamp\x18\x03 \x01(\x03R\ttimestamp\x12\x18\n" +
	"\asuccess\x18\x04 \x01(\bR\asuccess\"\xa0\x02\n" +
